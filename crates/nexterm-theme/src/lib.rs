...
pub fn builtin_theme(name: &str) -> Option<Theme> {
    match name.to_lowercase().replace(['-', '_', ' '], "") {
        ...
        s if s.contains("onedark") || s.contains("one") && s.contains("dark") => {
            Some(one_dark())
        }
...
pub fn one_dark() -> Theme {
    Theme {
        ...
        colors: ThemeColors {
            ...
            ansi: [
                "#3f4451".into(), "#e06c75".into(), "#98c379".into(), "#e5c07b".into(),
                "#61afef".into(), "#c678dd".into(), "#56b6c2".into(), "#abb2bf".into(),
                "#4f5666".into(), "#be5046".into(), "#7a9f60".into(), "#d19a66".into(),
                "#3b84c0".into(), "#9a52af".into(), "#3c909b".into(), "#828997".into(),
            ],
        },
        cursor: CursorColors {
